 ...
 if(isset($_POST['submit']))
    {
      ...
      window.location.href='offer.php';</script> ";
       ...
       <div class="card card-header bg-secondary shadow" style="margin-left:700px;width:300px;">
...
<button  class="btn btn-primary" name="submit">Offer</button>
 ...
 <div class="card card-body bg-secondary" style="margin-left:700px;width:300px;margin-top:-40px;">
